...
def transcribe_audio(audio_content: bytes, sample_rate: int = 48000, encoding: str = "WEBM_OPUS", language_code: str = "en-US",enable_automatic_punctuation: bool = True) -> dict:
    """
    Transcribe audio blob using Google Cloud Speech-to-Text API.
    
    Args:
        audio_content: Audio data as bytes
        sample_rate: Sample rate of the audio (default: 48000 Hz)
        encoding: Audio encoding format (default: "WEBM_OPUS") Options: "LINEAR16", "WEBM_OPUS", "OGG_OPUS", "MP3", etc.
